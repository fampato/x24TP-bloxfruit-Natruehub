game.StarterGui:SetCore("SendNotification", {
	Title = "Natrue x Hub", 
	Text = "load ui Script",
	Icon = "http://www.roblox.com/asset/?id=11326098114",
	Duration = 2
	})
	wait(2)
	game.StarterGui:SetCore("SendNotification", {
...
function CheckLevel()
	...
	if  FirstSea then
		...
		elseif Lv == 275 or Lv <= 299 or SelectMonster == "Gladiator [Lv. 275]" then -- Gladiator
			...
			NameMon = "Gladiator"
			CFrameQ = CFrame.new(-1577.7890625, 7.4151420593262, -2984.4838867188)
			CFrameMon = CFrame.new(-1428.95532, 7.78580475, -3188.54736, 0.324846625, 1.09517533e-08, 0.945766687, -2.88760518e-08, 1, -1.66157788e-09, -0.945766687, -2.677025e-08, 0.324846625)
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://11326098114"
	...
	ImageLabelfps.Image = "rbxassetid://11326098114"
	...
	ImageLabeltime.Image = "rbxassetid://11326098114"
	...
	Yedhee.TextTransparency = 1
		...
		function uitab:Tab(text,logo1)
			...
			function main:Button(text,callback)
				...
				IMGBUTTON.Image = "http://www.roblox.com/asset/?id="
...
local win = library:Window("Natrue",[[Hub]],[[Version : Beta ]],"11326098114",Enum.KeyCode.RightControl)
...
General_Tab:Toggle("Strat KaiTun Mode","9606294253",_G.Setting_table.AutoFarm,function(vu)
	Auto_Farm = vu
    _G.MonterBring = vu
	Part_Farm = vu
                                        ...
                                        repeat game:GetService("RunService").Heartbeat:wait()
                                            if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
                                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                                    ...
                                                    TP(v.HumanoidRootPart.CFrame * CFrame.new(0,37,0))
...
spawn(function()
	while task.wait() do
		if _G.MonterBring then
			CheckLevel()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if Auto_Farm and MagnetActive and v.Name == Ms and (Ms == "Royal Squad [Lv. 525]" or Ms  == "Factory Staff [Lv. 800]" or Ms == "Monkey [Lv. 14]" or Ms  == "Dragon Crew Warrior [Lv. 1575]" or Ms  == "Dragon Crew Archer [Lv. 1600]" or Ms  == "Head Baker [Lv. 2275]" or Ms == "Baking Staff [Lv. 2250]" or Ms  == "Cake Guard [Lv. 2225]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
				...
				elseif Auto_Farm and MagnetActive and v.Name == Ms and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 275 then
					v.HumanoidRootPart.CFrame = PosMon
					v.Humanoid:ChangeState(14)
					v.HumanoidRootPart.CanCollide = false
					v.Head.CanCollide = false
					...
					sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
					if Auto_Spikey_Trident and StatrMagnet  then
                        if (v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]") and (v.HumanoidRootPart.Position - PosMon.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v.HumanoidRootPart.CFrame = PosMon
